...
Automatic official resolution currently covers Adélie Linux, antiX Linux, Arch Linux, Artix Linux, MX Linux,
...
Harvester HCI, Hiren's BootCD PE, Kali Linux, KaOS, KDE neon, Security Onion, Talos Linux,
